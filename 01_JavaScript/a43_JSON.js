...
// TODO
console.log(JSON.stringify(myObj)); //object->string //이건 문자열 클라이언트와 서버 간에 데이터 주고 받을 때 사용

myJSON = '{"name":"John", "age":31, "city":"New York"}'; //문자열. 오브젝트 아님
myObj = JSON.parse(myJSON); //object <- string
console.log(myObj.name); //오브젝트가 아니면 못씀
// TODO

arr = [ "John", 'Peter', 'Sally', "Jane" ]; //배열도 오브젝트이기에 변환 가능
// TODO
console.log(JSON.stringify(arr)); //문자열로 변환
