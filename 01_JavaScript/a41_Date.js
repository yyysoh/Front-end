...
[
    ...
    // 7월 7일을 출력하려면..
    new Date(2022, 6, 7, 10, 38, 32, 0), //월이 0부터 11까지로 나옴, 10 38 32는 그리니치 천문대 시간으로 나옴

    // 실제 해당월의 날짜(day)보다 큰 값이 입력되어도, 에러 없이 overflow 처리됨
    new Date(2018, 5, 35, 10, 33, 30), //35일이 7월로 넘어가서 계산 //6월 35일 -> 7월 5일
    ...
    new Date(2018, 11), // 12/1 00:00:00
    //브라우저에선 제대로 나옴

    new Date(2018), //1970-01-01 ... 이렇게 나옴 얘만 넣는 건 안됨 정수 하나만 넣으면 ms로 본다
    ...
    new Date(99, 11, 23), //1999
    new Date(9, 11, 23) //1909
...
arr = [
    Date.parse('March 21, 2012'), //ms로 나옴 1970년부터 이만큼 흐름   // string -> millisec
...
/* Date get 메소드들
    ...
    getDate()	Get the day as a number (1-31) 일을 리턴한 것
    getHours()	Get the hour (0-23)
    getMinutes()	Get the minute (0-59)
    getSeconds()	Get the second (0-59)
    getMilliseconds()	Get the millisecond (0-999)
    getTime()	Get the time (milliseconds since January 1, 1970)
    getDay()	Get the weekday as a number (0-6) 요일을 리턴한 것
...
console.log(d1 > d2);
console.log(d1 > d3); //오브젝트끼리는 false인데 이것만 특수한 경우
